...
本功能分支实现本人收藏添加/取消/分页，V5唯一关系及非级联外键，复用公开物品可见性；不可见物品返回无内容占位，total包含所有本人关系。重复和并发操作、隔离MySQL约束验证及D接入说明见 [a02-favorites.md](a02-favorites.md)，协作见 [Issue #17](https://github.com/429res/campus-loop/issues/17)。本批未修改推荐算法或用户页面，D-02接入/消费确认及浏览器/微信联调仍未完成；本人物品管理PR #16、审核及正式交换保持独立。
