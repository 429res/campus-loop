...
<template>
  <LoopLayout active-tab="profile">
    ...
    <view v-else class="cl-panel cl-empty"><LoopIcon name="user" tone="primary" :size="36"/><text>登录后管理本人资料</text><text class="cl-hint">登录后可查看自己的物品、需求和交换进度。</text><LoopButton class="cl-btn cl-btn--primary" @click="login()">登录</LoopButton></view>
