...
const segment = ref(0), text = ref(''), date = ref(''), condition = ref(1), checked = ref(true), page = ref(1), sheet = ref(false), image = ref(''), busy = ref(false), failed = ref(false), materialReduced = ref(false)
