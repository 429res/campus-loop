...
<template>
  <LoopLayout active-tab="matches">
    <view class="match-heading"><view class="cl-page-heading"><text class="match-kicker">A LITTLE MATCH, A NEW LOOP</text><text class="cl-title">交换灵感</text><text class="cl-subtitle">看看有哪些合适的交换，也和同学聊聊闲置的新去处。</text></view><LoopIcon class="match-symbol" name="exchange" tone="primary" :size="64"/></view>
    <LoopSegment v-model="section" :options="['为你匹配','校园动态']" class="section-tabs"/>
    ...
    <view v-else-if="loading" class="cl-empty"><text class="cl-label">正在寻找合适的交换…</text></view>
