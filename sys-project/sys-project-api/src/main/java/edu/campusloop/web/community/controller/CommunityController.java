...
public class CommunityController {
 ...
 @PatchMapping("/{id}") public ResultVo<?> edit(@PathVariable long id,@RequestAttribute(AuthInterceptor.USER)User user,@Valid @RequestBody CommunityService.Edit body){return ResultVo.success(service.edit(user.getId(),id,body));}
