...
public class MemberService {
 public record Profile(long id,String displayName,String avatarUrl,String bio,String campus,long itemCount,long exchangeCount){}
 ...
 public Profile profile(long id){
  ...
  return new Profile(id,u.getDisplayName(),u.getAvatarUrl(),u.getBio(),u.getCampus(),items,exchanges);
 }
}
