...
public record ItemView(long id,long ownerId,String ownerName,String title,String description,long categoryId,
    ...
    List<String> wantedTags,String imageUrl,String status,@com.fasterxml.jackson.annotation.JsonFormat(pattern="yyyy-MM-dd'T'HH:mm:ss'Z'") LocalDateTime createdAt) {}
