...
public class AdminUserService {
    ...
    public PageResult<AdminUserView> page(int page,int size,String keyword,String role,String status) {
        ...
        QueryWrapper<User> query=new QueryWrapper<User>().isNull("deleted_at").eq("system_account",false);
    ...
    public AdminUserView updateStatus(long operatorId,long targetId,UpdateUserStatusRequest request) {
        ...
        if(target==null||target.getDeletedAt()!=null||Boolean.TRUE.equals(target.getSystemAccount())) throw new ApiException(404,"用户不存在");
