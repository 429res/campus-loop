...
public record HistoryView(long id,long itemId,String eventType,String statement,String evidenceLevel,String authorDisplayName,
    ...
    Long authorId,Long relatedExchangeId,List<Evidence> evidence,boolean canCorrect,String recordedEvidenceLevel,HistoryConfirmationView confirmation,com.fasterxml.jackson.databind.JsonNode verification) {
